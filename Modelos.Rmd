...
meteo_all <- meteo_all %>%
    ...
    dplyr::mutate(vel_viento_24h = rollmean(VEL_VIENTO, k = 24, fill = NA, align = "right"),
                  ...
                  vel_viento_72h = rollmean(VEL_VIENTO, k = 72, fill = NA, align = "right"),
                  dir_viento_72h = rollmean(DIR_VIENTO, k = 72, fill = NA, align = "right"),
                  temperatura_72h = rollmean(TEMPERATURA, k = 72, fill = NA, align = "right"),
                  humedad_72h = rollmean(HUMEDAD, k = 72, fill = NA, align = "right"),
                  presion_72h = rollmean(PRESION, k = 72, fill = NA, align = "right"),
                  radiacion_72h = rollmean(RADIACION_SOLAR, k = 72, fill = NA, align = "right"),
                  precipitacion_72h = rollmean(PRECIPITACION, k = 72, fill = NA, align = "right"),
                 ) %>% 
  dplyr::ungroup()

# Quitamos algunas observacioens (las primeras 72 horas) que no tienen valor para alguna de las nuevas variables que hemos creado.
...
Vamos a crear 4 datasets diferentes con los datos meteorológicos del momento, la media de las últimas 24 horas, la media de las últimas 48 horas y las últimas 72 horas.
