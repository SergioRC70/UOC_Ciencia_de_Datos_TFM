...
#colnames(datos_diarios_aire) <- c("ESTACION", "SO2", "NO2", "PM25", "PM10", "O3", "FECHA")
colnames(datos_diarios_aire) <- c("ESTACION", "ANO", "MES", "DIA", "SO2", "NO2", "PM25", "PM10", "O3")

datos_diarios_aire$SO2 <- as.integer(datos_diarios_aire$SO2)
datos_diarios_aire$NO2 <- as.integer(datos_diarios_aire$NO2)
datos_diarios_aire$PM25 <- as.integer(datos_diarios_aire$PM25)
datos_diarios_aire$PM10 <- as.integer(datos_diarios_aire$PM10)
datos_diarios_aire$O3 <- as.integer(datos_diarios_aire$O3)
...
datos_horarios_aire <- datos_horarios_aire[,c(1,6, 9:11, 13, 20)]
colnames(datos_horarios_aire) <- c("ESTACION", "SO2", "NO2", "PM25", "PM10", "O3", "FECHA")
